      ...
      >
        ...
        <div className="border-t border-gray-200 bg-gray-50/50 p-4">
          <div className="flex justify-between items-center">
            ...
            <button
              onClick={onClose}
              className="px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition-colors font-semibold text-sm hover:scale-105 active:scale-95 transform duration-200"
            >
              Close Analysis
            </button>
          </div>
