...
export default function SubjectDetail() {
  ...
  const targetGrade = subject.target_grade ? parseFloat(subject.target_grade.toString()) : 0;
                ...
                <div key={component.id} className="bg-white rounded-xl border border-gray-300 p-6">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-sm text-gray-600">
                        Grade: {componentProgress.scaledGrade.toFixed(2)}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 mb-4">
                    {(component.items ?? []).map((item, itemIndex) => (
                      <div key={itemIndex} className="grid grid-cols-4 gap-4 py-2 border-b border-gray-200 last:border-b-0">
                        <div>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span>{currentGrade.toFixed(2)} / {targetGrade.toFixed(2)}</span>
                  </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <input
                  ...
                  placeholder="Score"
                  value={newItem.score || ""}
                  onChange={(e) => setNewItem({...newItem, score: e.target.value ? parseInt(e.target.value) : null})}
              ...
              <input
                ...
                onChange={(e) => setNewItem({...newItem, target: e.target.value ? parseInt(e.target.value) : null})}
                className="w-full p-2 border rounded"
              />
            </div>
